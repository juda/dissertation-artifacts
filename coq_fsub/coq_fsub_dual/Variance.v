...
Proof with auto.
  ...
  -
    apply WF_rec with (L:=L \u {{X}});intros.
    rewrite_alist ((map (subst_tb X Y) ((X0 ~ bind_sub typ_bot) ++ E1)) ++ Y ~ bind_sub U ++ E2).
    rewrite  subst_tt_open_tt_var...
    rewrite_alist ((map (subst_tb X Y) ((X0 ~ bind_sub typ_bot) ++ E1)) ++ Y ~ bind_sub U ++ E2).
  ...
  -
    ...
    apply WF_rcd_cons...
    { apply subst_tt_rt_type with (E:= (E1 ++ X ~ bind_sub U) ++ Y ~ bind_sub typ_bot ++ E2)...
...
Proof with auto.
  ...
  -
    ...
    +
      rewrite_env (map (subst_tb X Y) (X0~bind_sub typ_bot ++ E1) ++ (Y, bind_sub U) :: E2).
      rewrite subst_tt_open_tt_var...
      apply WF_replacing...
      simpl...
      apply H...
...
Proof with eauto.
  ...
  -
    ...
    +
      rewrite subst_tl_open_tt_var...
      rewrite_env (map (subst_tlb X Y) (X0 ~ bind_sub typ_bot ++ E)).
      apply WF_renaming_tlb...
      apply H...
    +
