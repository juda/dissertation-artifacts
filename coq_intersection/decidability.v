...
Proof with auto.
  ...
  induction k.
  -
    intros A;induction A;intros B;induction B;intros;try solve [solve_right_dec|solve_top_dec E|unfold bindings in *;simpl in *;lia]...
    +
    ...
    +
      ...
      *
        ...
        dependent destruction v...        
  -
    intros A;destruct A;intros B;destruct B;intros;try solve [solve_right_dec|solve_top_dec E]...
    +
      simpl in H.
      apply bindings_decompose_and in H.
      destruct_hypos.
      destruct IHk with (E:=E) (A:=typ_top) (B:=B1);destruct IHk with (E:=E) (A:=typ_top) (B:=B2);try solve [auto|solve_right_dec]...
    +
      solve_right_dec.
      dependent destruction H1...
    +
    ...
    +
      ...
      apply bindings_decompose_and in H.
      destruct_hypos.
      destruct IHk with (E:=E) (A:=typ_nat) (B:=B1);destruct IHk with (E:=E) (A:=typ_nat) (B:=B2);try solve [auto|solve_right_dec]...
    +
      solve_top_wfs_dec E (n).
    +
      solve_right_dec.
    ...
    +
      ...
      destruct_hypos.
      destruct IHk with (E:=E) (A:=a) (B:=B1);destruct IHk with (E:=E) (A:=a) (B:=B2);try solve [auto|solve_right_dec]...
    +
      apply add_less in H.
      destruct_hypos.
      apply bindings_decompose_and in H.
